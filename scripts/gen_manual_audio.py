...
NARRATIONS = [
    ...
    "パスワードは、ご自身で変更できます。画面右上の、鍵マークのパスワード変更ボタンを押し、現在のパスワードと、新しいパスワードを8文字以上で入力して、変更するを押します。変更しても他の府県には影響しません。サイト管理とサイト構築は別々のパスワードなので、それぞれの画面で変更します。パスワードを忘れたときは、ブロック事務局にご連絡ください。",
