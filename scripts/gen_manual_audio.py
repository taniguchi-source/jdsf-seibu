...
NARRATIONS = [
    ...
    "スプレッドシートを選ぶと、色やセルの結合、太字などの書式をそのまま表示できます。シート名はシート一覧から選ぶで一覧から選べ、表示する範囲は、シートから範囲を選ぶで、開始セルと終了セルをクリックして指定できます。",
    "AIで見やすく整形を押すと、委員会サイト風の見やすい表に自動で整え直せます。追加の指示の欄に、氏名を太字に、参与を左、行間を詰めて、のように日本語で書くと、太字、色、文字サイズ、背景色、左右の配置や行間まで反映できます。",
    "公開ページの表の下には、印刷・PDF保存のボタンが自動で付きます。閲覧する方がこれを押すと、表だけを取り出して印刷でき、送信先でPDFに保存を選べば、そのままPDFとして保存できます。",
