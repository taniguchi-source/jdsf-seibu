...
NARRATIONS = [
    ...
    "役員ページのパスワードも、サイト構築ページでまとめて変更できます。役員ページ右上の、サイト構築ページへを押して開き、右上の、鍵マークのパスワード変更ボタンを押します。変更するパスワードで、役員用か、サイト構築ページ用を選び、その現在のパスワードと、新しいパスワードを8文字以上で入力して、変更するを押します。パスワードを忘れたときは、ブロック事務局にご連絡ください。",
